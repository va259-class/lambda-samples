...
public class MovieRepository
{
    public List<Movie> GetMovies()
    {
        return new List<Movie>
        {
            ...
            new Movie { Id = 31, Title = "The Revenant", ReleaseYear = 2015, Genre = Genre.Drama, Country = Country.USA, Rating = 8.0m },
            new Movie { Id = 32, Title = "Spotlight", ReleaseYear = 2015, Genre = Genre.Drama, Country = Country.USA, Rating = 8.1m },

            new Movie { Id = 33, Title = "Doctor Strange", ReleaseYear = 2016, Genre = Genre.Action, Country = Country.USA, Rating = 7.5m },
            new Movie { Id = 34, Title = "Moonlight", ReleaseYear = 2016, Genre = Genre.Drama, Country = Country.USA, Rating = 7.9m },
            new Movie { Id = 35, Title = "Logan", ReleaseYear = 2017, Genre = Genre.Action, Country = Country.USA, Rating = 8.1m },
            new Movie { Id = 36, Title = "Call Me by Your Name", ReleaseYear = 2017, Genre = Genre.Romance, Country = Country.France, Rating = 7.8m },
            new Movie { Id = 37, Title = "Avengers: Infinity War", ReleaseYear = 2018, Genre = Genre.Action, Country = Country.USA, Rating = 8.4m },
            new Movie { Id = 38, Title = "A Quiet Place", ReleaseYear = 2018, Genre = Genre.Thriller, Country = Country.USA, Rating = 7.5m },
            new Movie { Id = 39, Title = "Avengers: Endgame", ReleaseYear = 2019, Genre = Genre.Action, Country = Country.USA, Rating = 8.4m },
            new Movie { Id = 40, Title = "Ford v Ferrari", ReleaseYear = 2019, Genre = Genre.Drama, Country = Country.USA, Rating = 8.1m },

            new Movie { Id = 41, Title = "Dune", ReleaseYear = 2021, Genre = Genre.SciFi, Country = Country.USA, Rating = 8.0m },
            new Movie { Id = 42, Title = "No Time to Die", ReleaseYear = 2021, Genre = Genre.Action, Country = Country.UK, Rating = 7.3m },
            new Movie { Id = 43, Title = "Everything Everywhere All at Once", ReleaseYear = 2022, Genre = Genre.SciFi, Country = Country.USA, Rating = 8.0m },
            new Movie { Id = 44, Title = "Top Gun: Maverick", ReleaseYear = 2022, Genre = Genre.Action, Country = Country.USA, Rating = 8.3m },
            new Movie { Id = 45, Title = "Oppenheimer", ReleaseYear = 2023, Genre = Genre.Drama, Country = Country.USA, Rating = 8.6m },
            new Movie { Id = 46, Title = "Barbie", ReleaseYear = 2023, Genre = Genre.Romance, Country = Country.USA, Rating = 7.0m },
            new Movie { Id = 47, Title = "Dune: Part Two", ReleaseYear = 2024, Genre = Genre.SciFi, Country = Country.USA, Rating = 8.7m },
            new Movie { Id = 48, Title = "Civil War", ReleaseYear = 2024, Genre = Genre.Thriller, Country = Country.USA, Rating = 7.4m },
            new Movie { Id = 49, Title = "Avatar 3", ReleaseYear = 2025, Genre = Genre.SciFi, Country = Country.USA, Rating = 7.9m },
            new Movie { Id = 50, Title = "The Batman: Part II", ReleaseYear = 2026, Genre = Genre.Action, Country = Country.USA, Rating = 8.2m }
        };
    }
